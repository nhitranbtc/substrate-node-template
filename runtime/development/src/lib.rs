...
use frame_support::{
	...
	traits::{
		...
		EitherOfDiverse, EnsureOriginWithArg, EqualPrivilegeOnly, FindAuthor, Imbalance,
...
impl frame_system::Config for Runtime {
	...
	/// The aggregated RuntimeTash type.
	...
	type OnNewAccount = ();
	/// Wnat to do if an account is fully reaped from the system
...
// parameter_types! {
// 	pub const PostBlockAndTxHashes: PostLogContent = PostLogContent::BlockAndTxnHashes;
// }

// impl pallet_ethereum::Config for Runtime {
// 	type RuntimeEvent = RuntimeEvent;
// 	type StateRoot = pallet_ethereum::IntermediateStateRoot<Self>;
// 	type PostLogContent = PostBlockAndTxHashes;
...
mod runtime {
	...
	pub type UnifiedAccounts = pallet_unified_accounts::Pallet<Runtime>;
