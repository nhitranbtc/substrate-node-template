...
/// Alice for the Balance type for the provided Runtime and Instance.
pub type BalanceOf<Runtime, Instance = ()> = <Runtime as pallet_assets::Config<Instance>>::Balance;

/// Alice for the Asset Id type for the provided Runtime and Instance.
	...
	AssetIdOf<Runtime, Instance>: Copy,
{
	...
	fn total_supply(
		...
		//TODO: benchmark this function so we can measure ref time a PoV correctly
		// Storage item: Asset:
		// Blake2_128(16) + AssetId(16) + AssetDetails((4 * AccountId(32)) + (3* Balance(16)) + 15)

		handle.record_db_read::<Runtime>(233)?;
	...
	fn balance_of(
		...
		//TODO: benchmark this function so we can measure of ref time & PoV correctly
